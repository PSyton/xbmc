...
#include "upal/core/method/method4.h"
...
namespace upal {
  namespace handlers {
    ...
    class BaseHandler<R (A1, A2, A3, A4)>
      : public GuardedHolder
    {
      typedef BaseHandler<R (A1, A2, A3, A4)> ThisType;
      typedef upal::method<R (A1, A2, A3, A4)> ListenerFunction;
