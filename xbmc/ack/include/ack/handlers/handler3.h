...
#include "upal/core/method/method3.h"
...
namespace upal {
  namespace handlers {
    ...
    class BaseHandler<R (A1, A2, A3)>
      : public GuardedHolder
    {
      typedef BaseHandler<R (A1, A2, A3)> ThisType;
      typedef upal::method<R (A1, A2, A3)> ListenerFunction;
