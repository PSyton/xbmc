...
#include "upal/core/method/method1.h"
...
namespace upal {
  namespace handlers {
    ...
    class BaseHandler<R (A1)>
      : public GuardedHolder
    {
      typedef BaseHandler<R (A1)> ThisType;
      typedef upal::method<R (A1)> ListenerFunction;
