...
template<class ObjectType
  ...
  inline R free_call( const function_pointers& a_pointers, void* a_ptr, A1 a1, A2 a2, A3 a3 )
{
...
template<class ObjectType
  ...
  , typename R
  , typename FunctionPointer> 
  inline R free_call_multi( const function_pointers& a_pointers, void* a_ptr, A1 a1, A2 a2, A3 a3 )
{
...
template<typename A1
  ...
  , typename R
  , typename FunctionPointer> 
  inline R free_call_free( const function_pointers& a_pointers, void* , A1 a1, A2 a2, A3 a3 )
{
